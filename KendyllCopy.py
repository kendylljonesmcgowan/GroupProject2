...
def main(mainpoints,maincatlist,username,livesleft):
        ...
        print("We hope you have a blast getting to know each of our paw-some friends! Enjoy," + str(name) + "... and stay as long as you would like!")
        print()
        ...
        print()
        print(str(name) + " currently you have " + str(lives) + " life points left")
        print()
